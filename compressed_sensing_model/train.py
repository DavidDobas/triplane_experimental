...
class UNetWithAttention(nn.Module):
    def __init__(self, num_narrowings=3, c_dim=25, channels_first=128, use_camera_in=True, sparsity_level=0.1):
        super().__init__()
        ...
        for i in range(num_narrowings):
            ...
            self.encoder_blocks.append(nn.Sequential(
                ...
                nn.BatchNorm2d(out_channels),
                nn.ReLU(inplace=True),
                nn.Dropout(p=sparsity_level)  # Added Dropout for sparsity
            ))
